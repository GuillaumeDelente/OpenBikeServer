...
*/
	...
	public void process(HttpServletRequest req, HttpServletResponse resp)
		...
		int i = parseStations(result.toString());
	...
	public static int parseStations(String toParse) {
		...
		p = Pattern.compile("'latitude': '([^']*)', 'longitude': '([^']*)'[^#]*#(\\d*) - ([^<]*)</div>[^<]*<div class='gmap-adresse'>([^<]*)</div>(<div class='gmap-velos'>.*?<strong>(\\d+)</strong>.*?<strong>(\\d+)</strong>)?");
		m = p.matcher(toParse);
